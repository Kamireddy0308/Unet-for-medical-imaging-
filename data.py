...
def load_dataset(dataset_path):
    images = glob(os.path.join(dataset_path, "C:/Users/VISWKADE/Documents/Uniklinik_a/Uniklinik_a/1PIC/*"))
    masks = glob(os.path.join(dataset_path, "C:/Users/VISWKADE/Documents/segmentation mask labels/SegmentationClass/*"))
...
def tf_dataset(images, masks, batch=4):
    ...
    dataset = dataset.shuffle(buffer_size=480)
